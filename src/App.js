...
const Contact = ({ isVisible }) => {
  ...
  return (
    <section id="contact" data-animate className={`py-20 bg-gradient-to-br from-cyan-50 to-blue-100 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
